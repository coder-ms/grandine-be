...
<div class="container p-3 create-section">
    <h2>CREAZIONE PRATICA</h2>
    <form action="{{route('admin.practices.store')}}" method="POST" enctype="multipart/form-data" class="p-4">
        @csrf
        ...
        <div class="tab-content" id="pills-tabContent">
            ...
            <div class="tab-pane tab-height fade show active" id="pills-auto" role="tab-panel" aria-labelledby="pills-auto-tab">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('plate') is-invalid @enderror" value="{{old('plate')}}" id="plate" name="plate" required maxlength="7" minlength="7">
                    @error('plate')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('model') is-invalid @enderror" value="{{old('model')}}" id="model" name="model" required maxlength="50" minlength="3">
                    @error('model')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('model') is-invalid @enderror" value="{{old('immatricolation')}}" id="immatricolation" name="immatricolation" min="1900" max="2023">
            ...
            <div class="tab-pane fade tab-height" id="pills-client-1" role="tab-panel" aria-labelledby="pills-client-tab-1">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('owner') is-invalid @enderror" value="{{old('owner')}}" id="owner" name="owner" required maxlength="50" minlength="3">
                    @error('owner')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="tax_id_code" id="tax_id_code" class="form-control  @error('tax_id_code') is-invalid @enderror" required maxlength="16" minlength="16">
                    @error('tax_id_code')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="phone_number" id="phone_number" class="form-control  @error('phone_number') is-invalid @enderror" required maxlength="10" minlength="10">
                    @error('phone_number')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
